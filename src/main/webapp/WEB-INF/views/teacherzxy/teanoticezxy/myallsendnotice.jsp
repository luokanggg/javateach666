...
<body id="bods">
    ...
    <div data-options="region:'center',border:false">
        <!-- Begin of toolbar -->
        <div id="#sendnoticeinfo-toolbar">
            <div class="wu-toolbar-button">
                
                <form id="choice-search-form" style="display: inline-block">
			                   
			                   &nbsp;&nbsp;&nbsp; 被通知人姓名：<input class="easyui-textbox" style="height:25px;border-color: pink" name="tonotname" data-options="prompt:'Enter a tonotice name...'" id="tonotname"/>
			                 &nbsp;&nbsp;&nbsp;   
			                 信件类型：<select id="nottype" style="padding-left:3px;width:130px;height:25px;" >
         ...
         <!-- End of toolbar -->
         <div style="width:1330px;height:417px;">
        <table id="sendnoticeinfo-datagrid" toolbar="#sendnoticeinfo-toolbar"></table>  
        </div>
    </div>
	</div>
	
	<script type="text/javascript">
		  $('#sendnoticeinfo-datagrid').datagrid({
		        url:'getAllMysendnotice',
		        rownumbers: true,
		        singleSelect: true,
		        checkOnSelect:false,  
	            selectOncheck:false,
		  ...
		  $("#sendnoticeinfo-datagrid").datagrid('hideColumn', "id");
		    /* 搜索方法*/
		    ...
		    function ModifyNotice(){
		  		...
		  		var rows = $('#sendnoticeinfo-datagrid').datagrid('getSelections');  
		  		...
		  		$.messager.confirm('确认', '确定要删除吗？', function(r){
					if (r){
						...
						$.ajax({
							...
							data:param,//转换成字符串，客户端作为生产者
							success:function(result){
								if(result.mess=='该信件不是您发布，不可以删除'||result.mess=='该信件不可以执行逻辑删除！'){
									$.messager.alert("警告","       "+result.mess,"warning");
