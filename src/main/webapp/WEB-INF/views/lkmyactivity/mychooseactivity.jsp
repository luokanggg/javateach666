    ...
    <div data-options="region:'center',border:false">
        ...
        <div id="classinfo-toolbar">
            <div class="wu-toolbar-button">
                ...
                <a href="javascript:;" style="text-align: right;" class="easyui-linkbutton" iconAlign="right" iconCls="icon-back" onclick="openExportSearch()"
                   >返回</a>
            </div>
	...
	<script type="text/javascript">
		    ...
		    $('#classinfo-datagrid').datagrid({
				...
				onLoadSuccess:function(data){    
						$("a[name='opera']").linkbutton({text:'取消报名',plain:true,iconCls:'icon-cancel'});    
				}
		    });
		    /* 搜索方法*/
		    ...
		    function openExportSearch() {
				window.location.href = "gochooseactivity";
		  	}
		  	//发送消息
