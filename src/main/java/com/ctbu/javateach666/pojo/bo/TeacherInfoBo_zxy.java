...
public class TeacherInfoBo_zxy implements Serializable{
	...
	public String toString() {
		return "TeacherInfoBo_zxy [id=" + id + ", teaname=" + teaname + ", teaage=" + teaage + ", email=" + email
				+ ", teano=" + teano + ", joined_date=" + joined_date + ", professional=" + professional
				+ ", prosonal_statement=" + prosonal_statement + ", teaphone=" + teaphone + ", teaimage=" + teaimage
				+ ", teasex=" + teasex + ", teacollage=" + teacollage + ", teanation=" + teanation + ", political="
				+ political + ", major=" + major + ", toString()=" + super.toString() + "]";
	}
